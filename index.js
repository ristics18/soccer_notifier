    ...
    return new Promise((resolve, reject) => {
        ...
        function process_my_team() {
            ...
            data.notify_days_ahead.forEach(notifyDays  => {
                ...
                if (game !== null) {
                    games_coming_up.push(game);
                } 
            });

            var message = '';
            if (games_coming_up.length > 0)
            {
                message += 'You have soccer game(s) coming up!' + '\n' + '\n'
                games_coming_up.forEach(game_coming_up => {
            ...
            {
                var no_games_message = "\n---------------------------------------------------------------------------------\nNo games found for the team " + data.team_name + '\n' + "Email: " + data.email_recipients + '\n' + "Dates Checked: " + notify_days.toString() + '\n---------------------------------------------------------------------------------';
